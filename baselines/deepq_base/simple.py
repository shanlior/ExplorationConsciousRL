...
from baselines.deepq_base.replay_buffer import ReplayBuffer, PrioritizedReplayBuffer
from baselines.deepq_base.utils import BatchInput, load_state, save_state
...
class ActWrapper(object):
    ...
    def load(path):
        ...
        act = deepq_base.build_act(**act_params)
